...
public void move() {
	...
	System.out.println("Your Cat named " + this.getName() + " just move walkink");
}
...
public void eat(Eatable eatable) {
	...
	if (eatable instanceof Vegetable) {
        System.out.println("Your Cat named" + this.getName() + "just eat " + ((Vegetable) eatable).getName());
    } else if (eatable instanceof Animal) {
        System.out.println("Your Cat named" + this.getName() + "just eat " + ((Animal) eatable).getName());
    }
}
}
